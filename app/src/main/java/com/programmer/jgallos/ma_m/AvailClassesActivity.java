    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AvailClassesActivity.this, NotifyActivity.class);
        ...
        signinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //   final DatabaseReference newAttendance = databaseRef.push();
                ...
                Intent reviewIntent = new Intent(AvailClassesActivity.this, ClassReviewActivity.class);
                reviewIntent.putExtra("subjectReviewed", subject);
